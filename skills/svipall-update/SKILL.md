---
name: svipall-update
description: Check the installed Svipall version against the latest stable release and, only after the user chooses, update the shared user-owned binaries through their existing installation channel. Use when the user asks to check for, install, or manage Svipall updates.
---
